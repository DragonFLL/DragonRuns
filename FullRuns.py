...
class Lancamentos():
    ...
    async def L05(self):
            ...
            #Entrega no navio
            await spike.mover_forward(1.05, 'NO', 400)
    ...
    async def L08(self):
                ...
                await movimento(0.51, -900)

                await spike.Girar(50)

                await movimento(1.05, 700)
