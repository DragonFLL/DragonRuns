...
class Lancamentos():
    ...
    async def L03(self):
        motor_pair.pair(motor_pair.PAIR_1, port.F, port.E)
        motor.run_for_time(port.D, 500, 390)
        await movimento(0.47,650)
        await spike.Girar(90)
        await movimento(3.2, 400)

        await motor.run_for_time(port.B, 450, 500)
        ...
        await motor.run_for_time(port.B, 600, -1000 )
        await movimento(0.6, 400)
